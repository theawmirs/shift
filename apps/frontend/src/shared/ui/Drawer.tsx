        ...
        <>
          ...
          <motion.div
            ...
            style={{
              ...
              // Hardware-friendly: blur ONLY on desktop; mobile GPUs choke on Gaussian blur during sheet transitions
              backdropFilter: isDesktop ? "blur(6px)" : undefined,
              WebkitBackdropFilter: isDesktop ? "blur(6px)" : undefined,
            }}
          />

          {/* ── MODAL / SHEET LAYER ── */}
          <motion.div
            key={isDesktop ? "desktop-modal-wrap" : "mobile-sheet-wrap"}
            initial={{ opacity: 1 }}
            exit={{ opacity: 1 }}
